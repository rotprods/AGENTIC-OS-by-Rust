...
for (const vector of fixture.vectors) {
  if (vector.expected_sha256.includes("PLACEHOLDER")) continue;
...
console.log(`TypeScript golden parity PASS (${fixture.vectors.filter(v => !v.expected_sha256.includes("PLACEHOLDER")).length} vectors)`);
